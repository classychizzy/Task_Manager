...
const class_transformer_1 = require("class-transformer"); //whitespace handler
...
__decorate([
    ...
    (0, class_validator_1.MinLength)(5, { message: "Project name must be at least 5 characters long" }),
...
__decorate([
    ...
    (0, class_validator_1.MinLength)(10, { message: "Project description must be at least 10 characters long" }),
    (0, class_validator_1.IsNotEmpty)({ message: "Project description is required" }),
    __metadata("design:type", String)
