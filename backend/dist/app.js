...
class App {
    ...
    initializeMiddlewares() {
        ...
        if (fs.existsSync(openApiPath)) {
            const openApiDocument = yaml_1.default.parse(fs.readFileSync(openApiPath, 'utf8'));
            this.app.use('/api-docs', swagger_ui_express_1.default.serve, swagger_ui_express_1.default.setup(openApiDocument));
